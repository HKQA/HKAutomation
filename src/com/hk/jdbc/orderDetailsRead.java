...
public class orderDetailsRead {
    public static List<String>  orderdDetail() {
         JdbcConnectionFile.readJdbcprop("select b.gateway_order_id,c.store_variant_name from base_order b join cart_line_item c on b.id=c.base_order_id where gateway_order_id='" , new ResultSetExtractor<Object>() {
            String email = null;
            String email2 = null;
