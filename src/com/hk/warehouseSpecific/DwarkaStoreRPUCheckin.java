 ...
 */
public class DwarkaStoreRPUCheckin {
    ...
    public void doAfter(ITestResult result) throws IOException {
        ...
        if (result.getStatus() == ITestResult.FAILURE) {
            ...
            FileUtils.copyFile(screenshot, new File(System.getProperty("user.dir") + PropertyHelper.readProperty("screenshotFolder") + "\\DwarkaRPUCheckin.jpg"));
        }
    ...
    public void isSkip()
    {
        ...
        if(!(TestUtil.isExecutable("DwarkaStoreTest") && TestUtil.excel.getCellData("DWARKA_Store", "RunMode", 14).equalsIgnoreCase("Y") ) )
        {

            System.out.println("DwarkaRPUCheckin test would be skipped");
            throw new SkipException("Skipping the DwarkaRPUCheckin test case as RunMode is No");
    ...
    @Test
    public void testDwarkaStoreRPUCheckin() throws Exception {
    ...
    public static void main(String[] args) throws Exception {
        DwarkaStoreRPUCheckin test = new DwarkaStoreRPUCheckin();

        test.testDwarkaStoreRPUCheckin();
