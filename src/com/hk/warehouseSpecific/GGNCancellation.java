...
public class GGNCancellation {
    ...
    public void isSkip()
    {
        ...
        if(!(TestUtil.isExecutable("GGN") && TestUtil.excel.getCellData("GGN", "RunMode", 2).equalsIgnoreCase("Y") ) )
        {
    ...
    public void testGGNCancellation() throws Exception {
        ...
        String variant = null;
        variant = TestUtil.excel.getCellData("GGN", "Test Scenario", 4);
    ...
    public static void main(String[] args) throws Exception {
        ...
        GGNCancellation ggnCancellation = new GGNCancellation();

        //ggnCancellation.testGGNCancellation();
